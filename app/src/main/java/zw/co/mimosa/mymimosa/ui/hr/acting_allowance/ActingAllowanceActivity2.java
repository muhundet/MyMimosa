            ...
            public void onClick(View v) {
                ...
                builder.setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int whichButton) {
                        descriptionForActing = input.getText().toString();
                        ...
                        actingAllowanceHelper.setOvertime15Times(Long.parseLong(etOvertime15Times.getText().toString()));
                        actingAllowanceHelper.setOvertime20Times(Long.parseLong(etOvertime20Times.getText().toString()));
                        actingAllowanceHelper.setNighShiftAllowance(Long.parseLong(etNightShiftAllowance.getText().toString()));
                        actingAllowanceHelper.setStandbyWeeks(Long.parseLong(etStandbyWeeks.getText().toString()));
