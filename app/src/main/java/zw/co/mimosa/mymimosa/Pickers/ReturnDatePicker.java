...
public class ReturnDatePicker extends DialogFragment
    ...
    public void onDateSet(android.widget.DatePicker view, int year, int month, int dayOfMonth) {
        ...
        TextInputEditText startDate = (TextInputEditText) getActivity().findViewById(R.id.et_creturn_return_date);
